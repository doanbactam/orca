...
export const getStatsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Orca stats, subscription usage (Grok, Kimi, MiniMax), plus Claude, Codex, and OpenCode token analytics.'
    ),
    keywords: [
      ...
      translate('auto.components.stats.stats.search.c5d8e9f0a1', 'minimax'),
      translate('auto.components.stats.stats.search.b4c7d8e9f0', 'kimi'),
